    ...
    try {
        const response = await axios.post(
            'https://api.sendgrid.com/v3/mail/send',
            {
                ...
                headers: {
                    // RFC 2369 compliant: must include BOTH mailto: AND https: per SendGrid docs
                    // Gmail and Yahoo require both to display the native Unsubscribe button
                    'List-Unsubscribe': `<mailto:${fromEmail}?subject=Unsubscribe&body=Please%20unsubscribe%20me%20from%20campaign%20${campaignId}>, <${unsubscribeLink}>`,
