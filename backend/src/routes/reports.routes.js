...
// Weekly AI Performance Report — admin and manager only
router.get('/weekly-ai-report/latest', auth, requireRole('admin', 'manager'), reportsController.getLatestWeeklyReport);
router.get('/weekly-ai-report/history', auth, requireRole('admin', 'manager'), reportsController.getWeeklyReportsHistory);
