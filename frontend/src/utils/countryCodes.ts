...
const allCountries: Country[] = [
  ...
  { name: 'Antigua and Barbuda', flag: '🇦🇬', code: 'AG', dialCode: '+1' },
  ...
  { name: 'Dominica', flag: '🇩🇲', code: 'DM', dialCode: '+1' },
  { name: 'Dominican Republic', flag: '🇩🇴', code: 'DO', dialCode: '+1' },
  ...
  { name: 'Grenada', flag: '🇬🇩', code: 'GD', dialCode: '+1' },
  ...
  { name: 'Jamaica', flag: '🇯🇲', code: 'JM', dialCode: '+1' },
  ...
  { name: 'Trinidad and Tobago', flag: '🇹🇹', code: 'TT', dialCode: '+1' },
...
// Sort logic: USA always first, then others alphabetically
export const countryCodes: Country[] = [
  allCountries.find(c => c.code === 'US')!,
  ...allCountries.filter(c => c.code !== 'US').sort((a, b) => a.name.localeCompare(b.name))
];
