...
import { PhoneCall, Search, RefreshCw, Loader2, Calendar, Clock, User, ExternalLink, Play, Pause, X, Trash2 } from "lucide-react";
                  ...
                  calls.map((call) => (
                    <tr key={call._id} className="hover:bg-accent/10 transition-colors">
                      ...
                      <td className="py-2 px-3 font-semibold whitespace-nowrap">
                        {call.user_id && call.forwardedToUser ? (
                            ...
                            <Tooltip>
                              ...
                              <TooltipContent className="p-2.5 max-w-xs shadow-lg bg-popover text-popover-foreground rounded-lg border border-border">
                                <div className="space-y-1">
                                  <p className="text-[10px] font-bold text-primary uppercase tracking-wider">Initiating Agent</p>
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent className="p-2.5 max-w-xs shadow-lg bg-popover text-popover-foreground rounded-lg border border-border">
                              <div className="space-y-1">
                                <p className="text-[10px] font-bold text-primary uppercase tracking-wider">Team Member</p>
                                <p className="font-semibold">{call.user_id.name || call.user_id.username}</p>
                                <p className="text-xs text-muted-foreground font-normal">{call.user_id.email}</p>
                              </div>
                            </TooltipContent>
                        ...
                        {call.recordingUrl ? (
                          <div className="flex items-center justify-center gap-1.5">
                            <button
                              ...
                              className={`inline-flex items-center justify-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-bold transition-all duration-200 active:scale-95 ${
                                playingCall?._id === call._id
